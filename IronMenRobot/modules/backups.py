...
import IronMenRobot.modules.sql.notes_sql as sql
from IronMenRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from IronMenRobot.__main__ import DATA_IMPORT
from IronMenRobot.modules.helper_funcs.chat_status import user_admin
from IronMenRobot.modules.helper_funcs.alternate import typing_action

# from IronMenRobot.modules.rules import get_rules
import IronMenRobot.modules.sql.rules_sql as rulessql

# from IronMenRobot.modules.sql import warns_sql as warnssql
import IronMenRobot.modules.sql.blacklist_sql as blacklistsql
from IronMenRobot.modules.sql import disable_sql as disabledsql

# from IronMenRobot.modules.sql import cust_filters_sql as filtersql
# import IronMenRobot.modules.sql.welcome_sql as welcsql
import IronMenRobot.modules.sql.locks_sql as locksql
from IronMenRobot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("IronMenRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("IronMenRobot{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `IronMenRobot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("IronMenRobot{}.backup".format(chat_id))  # Cleaning file
