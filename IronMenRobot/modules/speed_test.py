import speedtest
from IronMenRobot import DEV_USERS, dispatcher
from IronMenRobot.modules.disable import DisableAbleCommandHandler
from IronMenRobot.modules.helper_funcs.chat_status import dev_plus
...
def speedtestxyz_callback(update: Update, context: CallbackContext):
    ...
    if query.from_user.id in DEV_USERS:
        ...
        query.answer("You are required to join @Dosto_ki_Mehfil786 to use this command.")
