...
from IronMenRobot.__main__ import STATS, TOKEN, USER_INFO
import IronMenRobot.modules.sql.userinfo_sql as sql
from IronMenRobot.modules.disable import DisableAbleCommandHandler
from IronMenRobot.modules.sql.global_bans_sql import is_user_gbanned
from IronMenRobot.modules.sql.afk_sql import is_afk, check_afk_status
from IronMenRobot.modules.sql.users_sql import get_user_num_chats
from IronMenRobot.modules.helper_funcs.chat_status import sudo_plus
from IronMenRobot.modules.helper_funcs.extraction import extract_user
from IronMenRobot import telethn as Iron_MenTelethonClient, TIGERS, DRAGONS, DEMONS
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' \n[<a href="https://t.me/Dosto_ki_Mehfil786">ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴋɴᴏᴡ ᴡʜᴀᴛ ɪs ᴅɪsᴀsᴛᴇʀ ʟᴇᴠᴇʟs.</a>]'.format(
            bot.username
        )
